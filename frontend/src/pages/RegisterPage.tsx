    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 bg-gray-50">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-1">Rejoignez FoxTown et tentez votre chance chaque jour.</p>
        </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-5">
          Déjà un compte ?{" "}
          <Link to="/login" className="text-fox-orange hover:underline font-medium">
            Se connecter
          </Link>
        </p>
      </div>
